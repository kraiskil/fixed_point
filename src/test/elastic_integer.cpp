...
namespace {
    ...
    namespace test_operate {
        ...
        static_assert(identical(
                ...
                elastic_integer<32>{}),
                "sg14::elastic_integer test failed");
        static_assert(elastic_integer<31>{-1} < elastic_integer<31>{1},
                "sg14::elastic_integer test failed");
        static_assert(31!=31 || !std::is_same<int, unsigned>::value, "");
        static_assert(
                sg14::_impl::cast_to_common_type(elastic_integer<31>{-1}, elastic_integer<31, unsigned>{1}),
                "");
        static_assert(
                sg14::_impl::operate(elastic_integer<31>{-1}, elastic_integer<31, unsigned>{1}, sg14::_impl::less_than_tag),
                "");
        static_assert(elastic_integer<31>{-1} < elastic_integer<31, unsigned>{1},
                "sg14::elastic_integer test failed");
//        static_assert(sg14::_impl::op_fn<sg14::_impl::less_than_op>(elastic_integer<31, unsigned>{-1},
...
//    static_assert(sg14::elastic_integer<10>{0} == 0, "");
//        static_assert(sg14::_impl::encompasses_lower<sg14::elastic_integer<10>, int>::value, "");
//        static_assert(!sg14::_impl::encompasses<sg14::elastic_integer<10>, int>::_upper, "");
//        static_assert(!sg14::_impl::encompasses<sg14::elastic_integer<10>, int>::_lower, "");
